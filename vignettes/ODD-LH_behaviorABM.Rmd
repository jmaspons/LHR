...
<!-- The model explores the interactions among life history and behavior and how they affect the population persitence in different scenarios. -->
...
$$j = \frac{sa^{1-AFR} \left(\lambda^{1+AFR} - a * \lambda^{AFR}\right)} {b * \lambda}$$
where $sa$ is the sub-adult survival, $a$ is the adult survival, $AFR$ is the age at first reproduction, and $b$ is the anual fecundity (broods * litter/clutch size).

<!-- TODO: habitat and behavior -->
